...
export default function TutorialPage() {
  return (
    <div className="mobile-page">
      ...
      <main className="mobile-content tutorial-screen space-y-4">
      ...
      <section className="glass rounded-2xl p-4 space-y-2">
        ...
        <ol className="text-xs text-slate-400 space-y-2 list-decimal list-inside">
          ...
          <li>
            Di bagian <span className="text-slate-200">"Access Permissions"</span>, klik menu pilihan, pilih{" "}
            <span className="text-slate-200">"Assets API"</span>, lalu tap <span className="text-slate-200">"Add API System"</span>
          </li>
          <li>
            Centang <span className="text-slate-200 font-medium">KEDUANYA</span>: <span className="text-slate-200">Read</span> dan{" "}
            <span className="text-slate-200">Write</span> — bukan salah satu doang. Write buat upload, Read buat ngecek status
            hasil moderasinya. Kalau cuma centang Write, nanti status upload gak bisa dicek dan macet di "Processing"
          </li>
          <li>
      ...
      <section className="rounded-2xl border border-amber-500/30 bg-amber-500/5 p-4 space-y-1">
        <p className="text-xs text-amber-300 font-medium">Kesalahan paling umum</p>
        <p className="text-xs text-slate-400">
          Kalau upload kamu selalu "Masih diproses" dan gak pernah berubah jadi Success/Rejected, biasanya karena
          API key-nya cuma dikasih izin Write doang. Balik ke Creator Dashboard, edit key-nya, tambahin izin Read.
        </p>
      </section>
      ...
      <Link
        href="/upload"
        className="block text-center rounded-2xl bg-gradient-to-r from-neon-blue to-neon-purple py-3 font-medium text-white shadow-glow tap-scale"
      >
        Lanjut ke Upload
      </Link>
      </main>
